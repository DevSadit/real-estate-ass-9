const Footer = () => {
  return (
    <footer className="px-4 divide-y bg-[#41B06E]  text-white py-14">
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        <div className="lg:w-1/3">
          ...
          >
            <div className="flex items-center justify-center w-12 h-12 rounded-full bg-[#D20062]">
              <img src="logo.png" alt="" />
            </div>
            <span className="btn text-3xl btn-ghost ">Nova Ventures</span>
          </a>
        </div>
