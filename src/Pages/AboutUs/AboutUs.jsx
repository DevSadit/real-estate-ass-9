  ...
  return (
    <div className="p-5 mx-auto sm:p-10 md:p-16  text-gray-100">
      <div className="flex flex-col max-w-3xl mx-auto overflow-hidden rounded">
        ...
        />
        <div className="p-6 pb-12 m-4 mx-auto -mt-16 space-y-6 lg:max-w-2xl sm:px-10 sm:mx-12 lg:rounded-md bg-[#B5C0D0] ">
          ...
          <div className="text-gray-100">
            <p>
              ...
              interests, and budget, ensuring that every aspect of your journey
              ...
              your travel dreams into reality. Embark on your next adventure
              with confidence, knowing that Radiant Journeys is here to support
              you every step of the way. Discover the world with us and unlock a
              world of possibilities. Your dream vacation starts here
            </p>
          </div>
        </div>
      </div>
